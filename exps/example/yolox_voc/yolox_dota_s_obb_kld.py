...
class Exp(MyExp):
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False):  #  no_aug=False
        ...
        dataset = DOTAOBBDetection(
            ...
            data_dir = 'E:/YGF/Yolox/YOLOX-OBB-main/YOLOX-OBB-main/DOTA_devkit_YOLO/DOTA_split',
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False):
        ...
        valdataset = DOTAOBBDetection(
            ...
            data_dir='E:/YGF/Yolox/YOLOX-OBB-main/YOLOX-OBB-main/DOTA_devkit_YOLO/DOTA_split', #add
            image_sets=[('2012', 'val')],
